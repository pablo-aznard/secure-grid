...
def create_scenario(world):
    ...
    attacks = attacksim.Attack.create(1, target_attr='P_out')
    ...
    # connect_randomly(world, attacks, nodes)
    for i in range(len(attacks)):
        world.connect(houses[i], attacks[i], ('P_out','P_out_val') , async_requests=True)
